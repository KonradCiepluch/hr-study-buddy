...
export const db = factory({
  student: {
    ...
    grades: () => [
      { subject: 'Modern Economy', average: getRandomAverage() },
      { subject: 'Trade and Logisitcs', average: getRandomAverage() },
      { subject: 'Business Philosophy', average: getRandomAverage() },
    ],
  },
  group: {
